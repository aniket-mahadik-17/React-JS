    ...
    render(){
        return(
            ...
            <form onSubmit={this.onFormSubmitClick}>
                ...
                <label>Email :</label>
                <input name="email" value={this.state.userObject.email} onChange={this.onChangeHandler}></input>
                <label>Website :</label>
                <input name="website" value={this.state.userObject.website} onChange={this.onChangeHandler}></input>
